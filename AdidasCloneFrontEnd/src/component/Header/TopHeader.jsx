...
const TopHeader = () => {
  ...
  useEffect(() => {
    setToken(getStorage("access_token"));
  }, []);
    ...
    },
    {
      ...
      label: (
        <div
          ...
          className="flex items-center gap-2"
        >
          <HomeOutlined /> Address Management
        </div>
      ),
    },
    {
  ...
  return (
    <div className="w-full bg-[#F5F5F5] px-4 md:px-12 py-2">
      <div className="max-w-[1920px] mx-auto flex justify-between items-center">
        ...
        {/* RIGHT —— Links + Account */}
        <ul className="flex items-center gap-4 text-[#111] font-[HerticalMedium]">
          {/* FIND A STORE — HIDE ON MOBILE */}
          <li className="hidden md:flex items-center gap-2">
            <a href="#" className="text-[12px] hover:text-black">
              Find a Store
            </a>
            <div className="h-[12px] border-r mx-2"></div>
          </li>
          ...
          {/* ALWAYS SHOW: Join Us / Sign In OR Account */}
          <li className="flex items-center">
            {!token ? (
              <div className="flex items-center gap-3">
                <Link to={path.signUpPage}>
                  <p className="text-[12px] hover:underline">Join Us</p>
                </Link>

                <div className="h-[12px] border-r"></div>

                <Link to={path.signInPage}>
                  <p className="text-[12px] hover:underline">Sign In</p>
                </Link>
              </div>
            ) : (
              <Dropdown
