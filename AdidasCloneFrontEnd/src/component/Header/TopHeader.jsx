...
const TopHeader = () => {
  return (
    <div className="px-[48px] max-w-[1920px] mx-auto grid grid-cols-12 items-center bg-[#F5F5F5]">
      <div className="col-span-6">
        <ul className="h-[36px] flex items-center">
          <li>
            <a href="#">
              <svg
                aria-hidden="true"
      ...
      <div className="col-span-6">
        <ul
          ...
          className="float-right pr-[8px] flex text-[#111111]"
        >
          <li className="flex items-center">
            <a href="#">
              <p className="text-[12px]">Find a Store</p>
            </a>
            <div className="h-[12px] border-r-1 border-solid m-[12px]"></div>
          </li>
          <li className="flex items-center">
            <a href="#">
          ...
          <li className="flex items-center">
            <a href="#">
              <p className="text-[12px]">Join Us</p>
            </a>
            <div className="h-[12px] border-r-1 border-solid m-[12px]"></div>
          </li>
          <li className="flex items-center">
